...
import resources.Individual_memberHelper;
 ...
 * @author AG18664
 */
public class Individual_member extends Individual_memberHelper
{
	/**
	 * Script Name   : <b>Individual_member</b>
	 * Generated     : <b>Aug 14, 2019 3:20:31 PM</b>
	 * Description   : Functional Test Script
...
//		
		...
		ibmExtensionForTerminalBasedAp().inputKeys("starmm01 ");
		b.enter();
		sleep(2);
		b.enter_text(5, 22, "BA");              
        b.enter();
        sleep(2);
        b.enter_text(5, 22, "BA");
        b.enter();
        sleep(2);
        b.enter_text(5, 22, "RC");
        b.enter();
        sleep(2);
        b.enter_text(13, 07, Contractcode);
        
        b.enter_text(13, 24, Zipcode);
        
        b.enter_text(13, 35,COuntycode);
          
        b.enter_text(13, 69, Effdate);
        
        b.enter_text(15, 02, "10");//10-Male sub,20-f sub,30 -M SP,40- F SP,50 -M CH,60 - F CH
        
        b.enter_text(15, 05, "u");
        
        b.enter_text(15, 08, Age);
        ...
        b.enter();
        sleep(2);
        b.enter_text(5, 22, "AA");
        b.enter();
        sleep(2);
        b.enter_text(5, 22, "AA");
        b.enter();
        
        b.enter_text(03, 44, ID);//9 digit
        
        b.enter_text(09, 06, contract_code);//4 digit
        
        b.enter_text(09, 15, effdate);
        
        b.enter_text(09, 25, "Y"); //PAY code indicator
        
        b.enter();
        
        b.F10();
        
        b.enter_text(07, 12, HOmeaddr);
        
        b.enter_text(08, 21, Zipcode);
        
        b.enter_text(08, 33,COuntycode); 
        
        b.enter_text(14, 12,"1");//Bill frequency 
     
        b.enter_text(15, 34,"Y");//Online ind
    
        b.enter_text(16, 60,"N");//converted business
        
        b.enter();
        
        //Renter the below fields
